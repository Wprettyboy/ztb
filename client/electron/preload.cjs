...
const bridge = {
  ...
  procurementAgent: {
    ...
    exportGeneratedWord: (payload) => ipcRenderer.invoke('procurement-agent:export-generated-word', payload),
    buildGeneratedPreview: (payload) => ipcRenderer.invoke('procurement-agent:build-generated-preview', payload),
